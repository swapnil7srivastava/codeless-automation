...
def execute_script():
    # Include pre_data at the beginning of script_content
    script_content = pre_data + "\n" + "\n".join(selected_functions)
    temp_file = "temp_script.py"
    temp_file_path = os.path.abspath(temp_file)  # Get the full path of the temp file
